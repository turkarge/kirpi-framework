...
<head>
  ...
  <style>pre{max-height:540px;overflow:auto;margin:0}.metric-label{font-size:.7rem;text-transform:uppercase;letter-spacing:.04em;color:var(--tblr-secondary)}</style>
</head>
<body>
<div class="page">
...
(() => {
  ...
  const appendLog = (text) => {
    ...
    activityLog.textContent = activityLog.textContent === 'No activity yet.' ? line : (line + '\n' + activityLog.textContent);
  };
