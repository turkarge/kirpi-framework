...
<head>
  ...
  <title>Kirpi Manager - System Modules</title>
...
<div class="page">
  ...
  <div class="page-wrapper">
    <div class="page-header py-2"><div class="container-xl"><h2 class="page-title">System Modules</h2></div></div>
    <div class="page-body py-2">
      <div class="container-xl">
        <div class="row row-cards g-2">
          <div class="col-12 col-xl-4">
            <div class="card"><div class="card-header py-2"><h3 class="card-title">Actions</h3></div><div class="card-body">
              ...
              <div class="d-grid gap-2">
                <button class="btn btn-primary btn-sm" id="btnModules">Load Modules</button>
                <button class="btn btn-outline-primary btn-sm" id="btnOverview">Load Overview</button>
                <button class="btn btn-outline-primary btn-sm" id="btnEnv">Load Env (masked)</button>
              </div>
            </div></div>
          </div>
